...
<?php if ( ! is_user_logged_in() ) : ?>
	<div class="king-alert"><i class="fa fa-bell fa-lg" aria-hidden="true"></i><?php esc_html_e( '1 You do not have permission to edit this post !', 'king' ); ?></div>
<?php elseif ( empty( $postid ) ) : ?>
	<div class="king-alert"><i class="fa fa-bell fa-lg" aria-hidden="true"></i><?php esc_html_e( '2 You do not have permission to edit this post !', 'king' ); ?></div>
<?php elseif (  ! get_field( 'enable_post_edit', 'options' )  ) : ?>
	<div class="king-alert"><i class="fa fa-bell fa-lg" aria-hidden="true"></i><?php esc_html_e( '3 You do not have permission to edit this post !', 'king' ); ?></div>
<?php elseif ( empty( $title ) ) : ?>
	<div class="king-alert"><i class="fa fa-bell fa-lg" aria-hidden="true"></i><?php esc_html_e( '4 You do not have permission to edit this post !', 'king' ); ?></div>
