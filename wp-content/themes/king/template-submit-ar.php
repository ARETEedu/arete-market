...
if ( isset( $_POST['king_ar_post_upload_form_submitted'] ) && wp_verify_nonce( $_POST['king_ar_post_upload_form_submitted'], 'king_ar_post_upload_form' ) ) {
...
<header class="page-top-header">
	<h1 class="page-title"><?php echo esc_html_e( 'Submit AR Files', 'king' ); ?></h1>
</header><!-- .page-header -->
		...
		<div id="primary" class="page-content-area">
			...
			<div class="king-form-group">
				...
				<div class="inside acf-fields">
					...
					<?php endif; ?>
					<?php echo wp_nonce_field( 'king_ar_post_upload_form', 'king_ar_post_upload_form_submitted', true, false ); ?>
