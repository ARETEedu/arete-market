...
<?php elseif ( ( 'list' === get_query_var( 'template' ) && get_field( 'disable_list', 'options' ) ) || ( 'poll' === get_query_var( 'template' ) && get_field( 'disable_polls', 'options' ) ) || ( 'trivia' === get_query_var( 'template' ) && get_field( 'disable_trivia', 'options' ) ) ) : ?>
	<div class="king-alert"><i class="fa fa-bell fa-lg" aria-hidden="true"></i><?php esc_html_e( 'You do not have permission to view this page!', 'king' ); ?></div>
					...
					?>
							...
							<div class="submit-news-right">
								<div class="submit-news-right-fixed">
									...
									<?php
									if ( ( '' === get_query_var( 'template' ) && get_field( 'enable_nsfw_for_news', 'options' ) ) ||
										( 'list' === get_query_var( 'template' ) && get_field( 'enable_nsfw_for_list', 'options' ) ) || 
										( 'poll' === get_query_var( 'template' ) && get_field( 'enable_nsfw_for_poll', 'options' ) ) || 
										( 'trivia' === get_query_var( 'template' ) && get_field( 'enable_nsfw_for_trivia', 'options' ) ) ) :
										?>
										<div class="king-nsfw">
