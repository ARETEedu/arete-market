...
<div class="king-notify">
	...
	<div class="king-notify-box <?php echo esc_attr( $flagc ); ?>" id="flagbox">
		...
		<div class="king-notify-menu" id="flagmenu">
			<ul id="kingflagin" class="king-notify-inside"><li class="king-clean-center"><div class="loader"></div></li></ul>
		</div>
	</div>
</div>
<?php endif; ?>
...
<div class="king-notify">
	...
	<div class="king-notify-box <?php echo esc_attr( $notifyclass ); ?>" id="notifybox">
		...
		<div class="king-notify-menu" id="notifymenu">
			<ul id="king-notify-inside" class="king-notify-inside"><li class="king-clean-center"><div class="loader"></div></li></ul>
		</div>
	</div>
</div>
<?php endif; ?>