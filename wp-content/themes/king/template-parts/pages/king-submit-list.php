...
?>
<div class="acf-field acf-field-repeater acf-field-58bddb0df74fe king-repeater" data-key="field_58bddb0df74fe" data-name="news_list_items" data-type="repeater">
	<div class="acf-input">
					...
					<tbody class="ui-sortable">
						<tr class="acf-row" data-id="row-0">
							...
							<td class="acf-fields">
										...
										<div class="acf-oembed">
											<input class="input-value" disabled="" name="acf[field_58bddb0df74fe][row-0][field_58bddbb9f7502]" type="hidden" value="">
												...
												<div class="canvas">
													...
													<i class="acf-icon -picture hide-if-value">
													</i>
												</div>
											</input>
										</div>
								...
								<div class="acf-field acf-field-textarea acf-field-58bddbd2f7503" data-key="field_58bddbd2f7503" data-name="news_list_content" data-type="textarea">
									<div class="acf-input">
										<textarea id="acf-field_58bddb0df74fe-row-0-field_58bddbd2f7503" name="acf[field_58bddb0df74fe][row-0][field_58bddbd2f7503]" rows="8" placeholder="<?php esc_html_e( 'description', 'king' ); ?>"></textarea>
									</div>
								</div>
							</td>
						</tr>
						<tr class="acf-row acf-clone" data-id="acfcloneindex" style="">
							...
							<td class="acf-fields">
								...
								<div class="acf-field acf-field-textarea acf-field-58bddbd2f7503" data-key="field_58bddbd2f7503" data-name="news_list_content" data-type="textarea">
									<div class="acf-input">
										<textarea disabled="" id="acf-field_58bddb0df74fe-acfcloneindex-field_58bddbd2f7503" name="acf[field_58bddb0df74fe][acfcloneindex][field_58bddbd2f7503]" rows="8" placeholder="<?php esc_html_e( 'description', 'king' ); ?>"></textarea>
									</div>
								</div>
							</td>
						</tr>
